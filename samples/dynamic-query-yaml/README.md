...
This places `io.dscope.camel:camel-snowflake:1.5.0` into your local Maven repository so the sample can depend on it.
...
java \
  ...
  -jar target/dynamic-query-yaml-1.5.0.jar
```
