 ...
 */
public class SampleParameterBindingTest extends CamelTestSupport {
    
    private static final Logger logger = LoggerFactory.getLogger(SampleParameterBindingTest.class);
