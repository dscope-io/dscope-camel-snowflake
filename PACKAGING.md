...
|-------------|------|------|---------|
| **OSGi Bundle** | `camel-snowflake-1.2.0.jar` | 30 KB | Enterprise deployment in OSGi containers (Karaf, Felix) |
| **Standalone JAR** | `camel-snowflake-1.2.0-standalone.jar` | 85 MB | Self-contained deployment with all dependencies |
| **Sources JAR** | `camel-snowflake-1.2.0-sources.jar` | 19 KB | Source code for developers and IDEs |
| **Javadoc JAR** | `camel-snowflake-1.2.0-javadoc.jar` | 156 KB | API documentation |
| **Distribution ZIP** | `camel-snowflake-1.2.0-distribution.zip` | 153 MB | Complete distribution with examples and docs |
| **Distribution TAR.GZ** | `camel-snowflake-1.2.0-distribution.tar.gz` | 153 MB | Unix/Linux distribution archive |
...
Export-Package: 
  io.dscope.camel.snowflake;version="1.2.0"
  io.dscope.camel.snowflake.jdbc;version="1.2.0"
  io.dscope.camel.snowflake.sql;version="1.2.0"
Import-Package: 
...
```bash
# Install in Karaf
karaf@root()> bundle:install file:///path/to/camel-snowflake-1.2.0.jar
...
```bash
# Add to classpath
java -cp "camel-snowflake-1.2.0-standalone.jar:your-app.jar" YourMainClass
```
