...
- **File**: `camel-snowflake-1.3.0.jar`
- **Size**: ~30 KB
...
- **File**: `camel-snowflake-1.3.0-standalone.jar`
- **Size**: ~85 MB
...
1. Copy `camel-snowflake-1.3.0.jar` to your OSGi container
...
1. Add `camel-snowflake-1.3.0-standalone.jar` to your classpath
