...
- **File**: `camel-snowflake-1.0.0-SNAPSHOT.jar`
- **Size**: ~30 KB
...
- **File**: `camel-snowflake-1.0.0-SNAPSHOT-standalone.jar`
- **Size**: ~85 MB
...
1. Copy `camel-snowflake-1.0.0-SNAPSHOT.jar` to your OSGi container
...
1. Add `camel-snowflake-1.0.0-SNAPSHOT-standalone.jar` to your classpath
